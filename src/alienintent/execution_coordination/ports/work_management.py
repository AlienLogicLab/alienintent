"""Provider-neutral import and projection boundary for noncanonical READY work."""
...
class ReadyWorkItem:
    identity: str; fifo: int; repository: str; profile: str; priority: int | None
    dependencies: tuple[str, ...]; contract: BiuContract; readiness_digest: str; readiness_evidence: str
