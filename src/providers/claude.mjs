...
export function claudeArguments(worker, bootstrap) {
  ...
  return [...["-p", "--no-session-persistence", "--output-format", "json", "--permission-mode", worker.permissionMode], ...extra, bootstrap];
}
