...
CONTROLS = [
    ...
    ("emptied-state-accepted", "014-repair-preservation", AC4, SERVICE_MODULE,
     ...
     "if state and not (_valid_state(state, requirement_id, version)",
    ...
    # Revision 4: control for the independent verifier's R1 repair.
    ("erased-history-accepted", "014-repair-preservation", AC4, SERVICE_MODULE,
     'if len(state["history"]) != version:', "if False:",
     COMPOSED, "test_erased_truncated_or_padded_history_is_a_hold"),
    ("history-chain-unchecked", "014-repair-preservation", AC4, SERVICE_MODULE,
     "or record.header.preceding_refs != _preceding(plan_ref, previous):", "or False:",
     COMPOSED, "test_erased_truncated_or_padded_history_is_a_hold"),
]
