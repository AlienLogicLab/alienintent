...
const suites = {
  runtime: ["test/dispatcher.test.mjs", "test/github-authority.test.mjs", "test/github-app.test.mjs",
    ...
    "test/worktree-manager.test.mjs", "test/worktree-lifecycle.test.mjs", "test/self-hosting.test.mjs", "test/systemd-supervision.test.mjs", "test/execution-conformance.test.mjs"],
