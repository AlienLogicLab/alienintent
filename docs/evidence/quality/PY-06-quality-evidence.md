# PY-06 — terminal Quality Evidence
...
Machine-readable measurement: [PY-06-quality-evidence.json](PY-06-quality-evidence.json). Prior measurements are retained in `superseded_measurement`, excluded from current aggregates.
