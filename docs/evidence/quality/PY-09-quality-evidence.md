# PY-09 — terminal Quality Evidence
...
Machine-readable measurement: [PY-09-quality-evidence.json](PY-09-quality-evidence.json). Prior measurements are retained in `superseded_measurement`, excluded from current aggregates.
