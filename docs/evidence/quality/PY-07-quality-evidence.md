# PY-07 — terminal Quality Evidence
...
Machine-readable measurement: [PY-07-quality-evidence.json](PY-07-quality-evidence.json). Prior measurements are retained in `superseded_measurement`, excluded from current aggregates.
