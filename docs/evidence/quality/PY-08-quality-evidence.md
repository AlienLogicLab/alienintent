# PY-08 — terminal Quality Evidence
...
Machine-readable measurement: [PY-08-quality-evidence.json](PY-08-quality-evidence.json). Prior measurements are retained in `superseded_measurement`, excluded from current aggregates.
