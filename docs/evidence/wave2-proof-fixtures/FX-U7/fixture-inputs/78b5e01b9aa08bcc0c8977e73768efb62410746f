...
2. The granted permissions and event subscriptions are verified to be **exactly** the least-privilege set; a simulated extra grant and a simulated missing grant each fail the check.
